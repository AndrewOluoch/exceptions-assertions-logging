...
public final class PhoneNumberFactory {
    ...
    public static PhoneNumber[] createRandomPhoneNumberArray(int phoneNumberCount) {
        ...
        for (int a=0;a<phoneNumberCount; a++){
            numbers[a] = createRandomPhoneNumber();
        }
    ...
    public static PhoneNumber createRandomPhoneNumber() {
        Integer rndarea= RandomNumberFactory.createInteger(100,999);
        Integer rndcof= RandomNumberFactory.createInteger(100,999);
        Integer rndplc= RandomNumberFactory.createInteger(1000,9999);
        return createPhoneNumberSafely(rndarea, rndcof, rndplc);
    }
